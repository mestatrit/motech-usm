...
/**
 * \ingroup MobileForms Mobile forms service interface, allows listing available mobile form groups. and get form
 * details.
 */

public interface MobileFormsService {
    /**
     * Get all form group names (study) along with index in an object array, first object is index and second one is
     * group name Object array is used in serializing this information to device.
     * 
     ...
     *            Index returned by {@link #getAllFormGroups()}
     * @return FormGroup
     */
    ...
    /**
     * Add a new group of forms to the mobile forms module. The group will be available for download after it has been
     * added
     * 
     * @param formGroup the Form Group to add
     */
