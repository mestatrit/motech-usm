...
<body>
	...
	<form method="post" action="/motech-platform-server/module/campaigndemo/user/add">
	...
	<form method="post" action="/motech-platform-server/module/campaigndemo/user/remove">
	...
	<form method="post" action="/motech-platform-server/module/campaigndemo/start">
		ID:<input type="text" name="externalId" size="12" maxlength="12" /> 
	...
	<form method="post" action="/motech-platform-server/module/campaigndemo/stop">
		ID:<input type="text" name="externalId" size="12" maxlength="12" /> 
		<input type="hidden" name="campaignName" value="Ghana Pregnancy Message Program" />
