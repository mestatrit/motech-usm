...
public class CouchDAOBroker {
    ...
    public Encounter buildFullEncounter(CouchEncounterImpl encounter) {
    ...
    private Set<Observation> generateObsIdSet(Set<String> observationIds) {
    ...
    public Patient buildFullPatient(List<CouchPatientImpl> couchPatients) {
    ...
    public Observation buildFullObservation(CouchObservationImpl obs) {
    ...
    private Set<Observation> getDependantObsById(Set<String> dependantObservationIds) {
        ...
        while (iterator.hasNext()) {
            ...
            Observation obs = returnObs(allObservations.findByObservationId(obsId));
            if (obs != null) {
    ...
    public Observation returnObs(List<CouchObservationImpl> couchObs) {
