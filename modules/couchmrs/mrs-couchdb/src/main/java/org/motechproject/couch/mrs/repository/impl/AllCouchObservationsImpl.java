...
public class AllCouchObservationsImpl extends MotechBaseRepository<CouchObservationImpl>  implements AllCouchObservations {
    ...
    @Override
    public void addOrUpdateObservation(Observation obs) {
    ...
    private CouchObservationImpl convertObsToImpl(Observation obs) {
    ...
    private Set<String> convertToStringIds(Set<Observation> dependantObservations) {

        if (dependantObservations == null) {
            return null;
        }

        Iterator<Observation> obsIterator = dependantObservations.iterator();
    ...
    private CouchObservationImpl updateOldObsWithNewObs(CouchObservationImpl oldObs, Observation newObs) {
