...
public class FormValidatorRegister implements ServletContextAware {
    ...
    public void setServletContext(ServletContext servletContext) {
        servletContext.setAttribute(
                PatientRegistrationValidator.class.getName(),
                patientRegValidator);
        servletContext.setAttribute(PatientEnrollmentValidator.class.getName(),
                patientEnrollValidator);
        servletContext.setAttribute(PatientEncounterValidator.class.getName(),
                patientEncounterValidator);
    }
}
