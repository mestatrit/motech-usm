...
public abstract class AbstractPatientValidator<V extends FormBean> extends
        AbstractMobileValidator<V> {
...
//    }
    ...
    protected void validateOpenMrsPatientExists(String motechId,
...
//                    "Could not find OpenMRS Patient with this MoTeCH Id"));
//        }
    }
