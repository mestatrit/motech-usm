...
import org.motechproject.openmrs.rest.impl.MRSEncounterAdapterImpl;
import org.motechproject.openmrs.rest.impl.MRSObservationAdapterImpl;
import org.motechproject.openmrs.rest.impl.MRSPatientAdapterImpl;
...
public class OpenMrsClientImpl implements OpenMrsClient {
    ...
    private MRSEncounterAdapterImpl encounterAdapter;
    private MRSPatientAdapterImpl patientAdapter;
    private MRSObservationAdapterImpl observationAdapter;

    @Autowired
    public OpenMrsClientImpl(MRSEncounterAdapterImpl encounterAdapter,
            MRSPatientAdapterImpl patientAdapter,
            MRSObservationAdapterImpl observationAdapter) {
