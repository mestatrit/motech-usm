...
<body>
	...
	<br>
	<br> This is a demonstration of schedule tracking with voice
	calling and SMS messaging. It uses the core platform (server,
	server-api, common) along with scheduler, scheduletracking, cmslite,
	sms-api, sms-http, voxeo, mrs-api and openmrs-api.
	<br>
	<br> Registering a duplicate id will overwrite its phone number
	...
	<form method="post"
		...
		Phone Number (with no special characters, like in 2071234567):<input
			...
			type="submit" value="Register Motech Patient" />
	</form>
